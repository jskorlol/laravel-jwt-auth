...
namespace Jskorlol\JwtAuth\Commands;
...
class JwtRefreshTestCommand extends Command
{
    ...
    private function testRefreshToken(string $refreshToken): void
    {
        ...
        try {
            ...
            $storage = app(\Jskorlol\JwtAuth\Interfaces\RefreshTokenStorageInterface::class);
            ...
            $jwt = \Jskorlol\JwtAuth\Data\Jwt::decode($newTokenData->accessToken);
            $this->newLine();
